...
在函数原型中，包含函数名和它们的数据类型。虽然 C 语言里没有这样的要求，在 Linux 里这
...
Linux 的注释风格是 C89 `/* ... */` 风格。不要使用 C99 风格 `// ...` 注释。
...
转载自 https://tinylab-1.gitbook.io/linux-doc/
> 翻译: 张乐 Zhang Le <r0bertz@gentoo.org>
